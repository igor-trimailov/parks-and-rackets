...
// ProjectArgs are generated from the schema
const projectWithTasks = Prisma.validator<Prisma.ProjectArgs>()({
    // a bit weird here, you need to specify this for the project to include Tasks tables
    // otherwise it will not be fetched(like population in Mongo)
    include: { tasks: true },
});
